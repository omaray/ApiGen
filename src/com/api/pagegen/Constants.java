...
public class Constants {
    ...
    // Templates
    public static final String API_PAGE_TEMPLATE = "./resources/templates/api_details_template.mustache";
    public static final String API_VARIABLE_PAGE_TEMPLATE = "./resources/templates/api_details_variables_template.mustache";
    public static final String API_LANDING_TEMPLATE = "./resources/templates/api_landing_template.mustache";
    public static final String API_LANDING_CLOUD_TEMPLATE = "./resources/templates/api_landing_cloud_template.mustache";
